...
class HeatmapSession:
    ...
    def render_heatmap_png(self) -> bytes | None:
        ...
        cv2.rectangle(
            ...
            (margin_left + plane_width, margin_top + plane_height),
            (70, 70, 70),
            2,
        )
        ...
        subtitle = (
            f"Projected from camera foot points  |  room={self.projection.room_width_units:.1f} x "
        ...
        cv2.putText(
            canvas,
            "Far side",
            (margin_left + plane_width - 110, margin_top - 18),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.6,
            (60, 60, 60),
            1,
        ...
        cv2.putText(
            canvas,
            "Near camera",
            (margin_left + plane_width - 135, margin_top + plane_height + 28),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.6,
            (60, 60, 60),
            1,
